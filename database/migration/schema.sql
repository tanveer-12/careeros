...
CREATE TABLE jobs (
    ...
    skills           TEXT[],         -- backward-compat mirror of skills_final
    ...
    -- Skill enrichment — generated by skill_enricher.py; source of truth for skill data
    skills_extracted      TEXT[],                       -- direct mentions found in text
    skills_normalized     TEXT[],                       -- canonical forms of extracted skills
    skills_inferred       TEXT[],                       -- domain-based skills not in text
    skills_final          TEXT[]  NOT NULL DEFAULT '{}',-- union used by app; GIN-indexed
    skills_confidence     REAL,                          -- 0.0–1.0 extraction confidence
    skills_source_version TEXT,                          -- enricher version, e.g. "v1"
...
-- Run once against lumia_dev before executing hdbscan_engine.py for the first time.
